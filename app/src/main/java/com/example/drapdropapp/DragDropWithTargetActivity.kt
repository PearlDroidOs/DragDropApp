...
import com.example.drapdropapp.databinding.ActivityDrapDropBinding
import java.util.*

class DragDropWithTargetActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDrapDropBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDrapDropBinding.inflate(layoutInflater)
